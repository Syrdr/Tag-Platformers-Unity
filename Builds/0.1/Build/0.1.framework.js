...
var ASM_CONSTS = {
  4512092: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4512147: ($0) => { performance.now = function() { return $0; }; },  
 4512195: ($0) => { performance.now = function() { return $0; }; },  
 4512243: () => { performance.now = Module['emscripten_get_now_backup']; }
};
